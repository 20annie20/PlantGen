...
#include "TreeGenPluginEditorMode.generated.h"
 ...
 */
UCLASS()
class UTreeGenPluginEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_TreeGenPluginEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UTreeGenPluginEditorMode();
	virtual ~UTreeGenPluginEditorMode();
